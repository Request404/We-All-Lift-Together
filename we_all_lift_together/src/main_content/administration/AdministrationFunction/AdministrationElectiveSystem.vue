<template>
  <div id="admin_elective_system_warp">
    <div @click="returnSystemHome">
      <return-system-home/>
    </div>
    <div id="admin_elective_system_container">
      ...
      <divider class="font">选修课程列表</divider>
      <Drawer
              title="添加课程信息"
              v-model="Draw"
              width="720"
...
<script>
  ...
  export default {
    name: "AdministrationElectiveSystem",
    components: {
      ReturnSystemHome
    },
    data(){
...
<style scoped>
  #admin_elective_system_warp{
    width: 85%;
    height: auto;
  }
  #admin_elective_system_container{
    width: 100%;
    height:auto;
